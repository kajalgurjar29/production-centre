...
const PERMISSIONS = {
  ...
  ADVERTS_MANAGE_TYPES: ['SUPER_ADMIN', 'ADMINISTRATOR', 'CONTENT_ADMIN'],
  ...
  AI_LEADS_UPDATE_STATUS: ['SUPER_ADMIN', 'ADMINISTRATOR', 'MODERATOR'],
  ...
  ADMIN_USERS_WRITE: ['SUPER_ADMIN', 'ADMINISTRATOR'],
};
